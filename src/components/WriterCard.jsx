...
const WriterCard = () => {
  return (
    <div className="flex flex-col gap-4 md:gap-10 justify-center items-center p-3 md:p-6 bg-gray-50 dark:bg-black">
      
      <div className="flex flex-col md:flex-row gap-4 md:gap-6 justify-center items-stretch">
        <div className="bg-white dark:bg-gray-600 shadow-lg rounded-xl p-4 md:p-6 w-[320px] md:w-[550px] flex flex-col">
          <div className="bg-gray-100 dark:bg-gray-600 p-4 md:p-6 rounded-lg relative text-center flex-1">
            ...
            <div className="grid grid-cols-2 gap-4 mt-6">
              {features.map((feature, index) => (
                <div key={index} className="flex items-center bg-white dark:bg-gray-400 shadow-md rounded-lg px-4 py-2">
          ...
          <div className="mt-6 dark:bg-gray-600">
            <h4 className="text-blue-600 dark:text-pink-600 text-sm font-bold uppercase">AI ARTICLE WRITER</h4>
            <h2 className="text-xl dark:text-white font-semibold mt-1">Most Advanced AI Article Writer</h2>
        ...
        <div className="bg-white dark:bg-gray-600 shadow-lg rounded-xl p-4 md:p-6 w-[320px] md:w-[550px] flex flex-col">
          ...
          <div className="p-4">
            <h4 className="text-blue-600 dark:text-pink-600 text-sm font-bold uppercase">INTEGRATIONS</h4>
      ...
      <div className="flex flex-col md:flex-row gap-4 md:gap-6 justify-center items-stretch">
        ...
        <div className="bg-white dark:bg-gray-600 shadow-lg rounded-xl p-4 md:p-6 w-[320px] md:w-[550px] flex flex-col justify-between">
          <div className="bg-gray-100 dark:bg-gray-400 p-4 rounded-lg text-center flex-1">
            <div className="grid grid-cols-3 gap-4">
              {workflowItems.map((item, index) => (
                <div
                  key={index}
                  className="flex flex-col items-center bg-white dark:bg-gray-600 shadow-md rounded-lg px-4 py-3"
                >
                  <img src={item.icon} alt={item.title} className="h-10 w-10" />
                  <span className="text-sm dark:text-gray-700 font-medium mt-2">{item.title}</span>
                </div>
              ))}
            </div>
          </div>
          <div className="mt-6">
            <h4 className="text-blue-600 dark:text-pink-600 text-sm font-bold uppercase">WORKFLOW</h4>
        ...
        <div className="bg-white dark:bg-gray-600 shadow-lg rounded-xl p-4 md:p-6 w-[320px] md:w-[550px] flex flex-col justify-between">
          <div className="p-2 md:p-4">
            <h4 className="text-pink-600 dark:text-pink-600 text-sm font-bold uppercase">Brand Consistency</h4>
            <p className="text-gray-600 dark:text-gray-300 text-sm mt-2">
          ...
          <div className="p-2 md:p-4">
            <h4 className="text-blue-600 dark:text-pink-600 text-sm font-bold uppercase">BRAND CONSISTENCY</h4>
            <h2 className="text-xl dark:text-white font-semibold mt-1">
